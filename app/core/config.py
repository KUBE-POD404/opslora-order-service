...
class Settings:
    service_name: str = _secret("SERVICE_NAME", "order-service")
    ...
    customer_service_url: str = _secret("CUSTOMER_SERVICE_URL", required=True)
    inventory_service_url: str = _secret("INVENTORY_SERVICE_URL", required=True)
